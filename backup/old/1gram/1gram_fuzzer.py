...
while(42):
    ...
    if _DEBUG:
        if ctr % 10 == 0:
            print("##################################")
            print("0.01 --> " + str(fuzzer.compute([0.01])[0][0]) + " || " + str(fuzzer.compute([0.01])[0][13]))
            print("0.5  --> " + str(fuzzer.compute([0.5])[0][0]) + " || " + str(fuzzer.compute([0.01])[0][13]))
            print("0.99 --> " + str(fuzzer.compute([0.99])[0][0]) + " || " + str(fuzzer.compute([0.01])[0][13]))
        ctr += 1
